...
export default function AdminHero() {
  return (
    <section className="relative isolate overflow-hidden rounded-xl sm:rounded-2xl lg:rounded-[2rem] border border-white/16 shadow-[0_24px_80px_rgba(15,23,42,0.24)]">
      ...
      <div className="relative grid gap-5 sm:gap-6 p-4 sm:p-6 md:p-8 lg:p-9 grid-cols-1 lg:grid-cols-[1.45fr_0.85fr] lg:items-stretch">
        <div className="flex flex-col justify-between">
          <div>
            <div className="mb-3 sm:mb-4 flex flex-wrap gap-2">
              <span className="rounded-full border border-emerald-400/30 bg-emerald-400/10 px-3 py-1 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.28em] text-emerald-100">
                Panel admin
              </span>
              <span className="rounded-full border border-sky-400/30 bg-sky-400/10 px-3 py-1 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.28em] text-sky-100">
                Reservas
              </span>
              <span className="rounded-full border border-white/12 bg-white/6 px-3 py-1 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.28em] text-white/70">
                Control operativo
              </span>
            </div>
            ...
            <p className="mt-3 sm:mt-4 lg:mt-5 max-w-2xl text-xs sm:text-sm lg:text-base leading-6 sm:leading-7 text-slate-200/82">
        ...
        <div className="grid gap-3 sm:gap-4">
          <div className="rounded-lg sm:rounded-2xl lg:rounded-[24px] border border-white/12 bg-slate-950/34 p-4 sm:p-5 shadow-sm backdrop-blur-sm">
            <p className="text-xs sm:text-sm text-emerald-200">Operacion</p>
            <p className="mt-2 text-lg sm:text-2xl font-semibold text-white">
              Filtros + metricas
            </p>
          </div>

          <div className="rounded-lg sm:rounded-2xl lg:rounded-[24px] border border-white/12 bg-slate-950/34 p-4 sm:p-5 shadow-sm backdrop-blur-sm">
            <p className="text-xs sm:text-sm text-sky-200">Accion</p>
            <p className="mt-2 text-lg sm:text-2xl font-semibold text-white">
              Check-in manual
            </p>
          </div>
          ...
          <div className="rounded-lg sm:rounded-2xl lg:rounded-[24px] border border-white/12 bg-slate-950/34 p-4 sm:p-5 shadow-sm backdrop-blur-sm">
            <p className="text-xs sm:text-sm text-white/56">Reporte</p>
            <p className="mt-2 text-lg sm:text-2xl font-semibold text-white">
              Exportacion Excel
            </p>
          </div>
