  ...
  return (
    <section className="relative isolate overflow-hidden rounded-[2rem] border border-white/20 shadow-[0_24px_80px_rgba(15,23,42,0.28)]">
      <img
        ...
        decoding="async"
        fetchPriority="high"
        className="absolute inset-0 h-full w-full scale-[1.02] object-cover object-[center_72%]"
      />
      <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(6,23,39,0.78),rgba(9,52,70,0.68)_45%,rgba(16,185,129,0.38))]" />
